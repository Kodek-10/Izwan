...
def auth_headers(client):
    client.post("/api/v1/auth/register", json={"username": "searchuser", "password": "password"})
    resp = client.post("/api/v1/auth/login", data={"username": "searchuser", "password": "password"})
