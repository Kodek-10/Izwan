      ...
      <section className="flex-1 flex flex-col items-center justify-center bg-white px-6 py-12 md:px-12 lg:px-24">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="auth-btn-social group" onClick={() => toast("Google Auth coming soon")}>
            ...
            <button className="auth-btn-social group" onClick={() => toast("GitHub Auth coming soon")}>
